...
from articleapp.api.views import ( ArticleDetailAPIView,
                        CommentListAPIView,CommentDetailAPIView,ArticleListAPIView, LikeArticle, )
...
urlpatterns = [
            ...
            path('articles/<int:pk>/like', LikeArticle.as_view(), name='article-like'),
            #path('articles/unlike/<int:pk>/', UnLikeArticle.as_view(), name='article-unlike'),
